...
| P03 | `[~]` | [External-target rebrand press (clean-core rebuild)](projects/P03-external-target-rebrand-press-.md) — M0–M5 complete; M4d closes on this delivery's merge; M6 provision remains; issue #42 prerequisite satisfied |
...
| P07 | `[~]` | [Platform-conditional declared commands](projects/P07-platform-conditional-declared-commands.md) — implementation and native validation complete in PR #79; T07 typing improvement awaits delivery and thread resolution; macOS thread resolved |
