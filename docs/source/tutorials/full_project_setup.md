...
- **Format**: `just format` or `uvx ruff format template_press/`
- **Lint**: `just lint` or `uvx ruff check template_press/`
- **Type check**: `just typecheck` or `uv run ty check src/template_press/`
