...
- **Status:** `[~]` in progress — Group 3C; declaration parsing and frozen
  directory selection reviewed and validated. Public directory execution remains
  gated until the executor and CLI integration are complete.
...
- [ ] [P11-T03] Task 3: exact deletion, safe empty-directory pruning, and complete bounded receipt history.
